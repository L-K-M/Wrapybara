#!/usr/bin/env bash
# Builds Wrapybara.app from the command line and reveals it in Finder on success.
...
set -euo pipefail
export BUILD_APP_NAME="Wrapybara"
export BUILD_KIND="xcode"
export BUILD_XCODE_PROJECT="Wrapybara.xcodeproj"
export BUILD_XCODE_SCHEME="Wrapybara"
